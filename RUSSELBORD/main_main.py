...
# === IMAGES ===
bg_img = pygame.image.load("IMAGES/flappybirdbg.png")

brd_img = pygame.image.load("IMAGES/russel.png")
brd_img = pygame.transform.scale(brd_img, (bird_w, bird_h))

top_pp_image = pygame.image.load("IMAGES/top.png")
top_pp_image = pygame.transform.scale(top_pp_image, (pipes_w, pipes_h))

bot_pp_image = pygame.image.load("IMAGES/bottom.png")
bot_pp_image = pygame.transform.scale(bot_pp_image, (pipes_w, pipes_h))

# == SOUNDS == 
flap_sound = pygame.mixer.Sound("SFX/sfx_wing.wav")
point_sound = pygame.mixer.Sound("SFX/sfx_point.wav")
hit_sound = pygame.mixer.Sound("SFX/sfx_hit.wav")
swoosh_sound = pygame.mixer.Sound("SFX/sfx_swooshing.wav")
die_sound = pygame.mixer.Sound("SFX/sfx_die.wav")
...
def draw():
    ...
    # === SCORE DISPLAY ===
    font_big = pygame.font.Font("FONT/flappy-font.ttf", 48) if pygame.font.get_fonts() else pygame.font.SysFont("Comic Sans MS", 48)
    font_small = pygame.font.Font("FONT/flappy-font.ttf", 28) if pygame.font.get_fonts() else pygame.font.SysFont("Comic Sans MS", 28)
